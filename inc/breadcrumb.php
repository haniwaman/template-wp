...
if ( ! function_exists( 'my_breadcrumb' ) ) {
	...
	function my_breadcrumb( $object_type = '' ) {
		...
		$breadcrumb_bridge_tag = '<li><span class="breadcrumb-bridge">' . $breadcrumb_bridge . '</span></li>';
		...
		if ( is_front_page() ) { /* Front Page */
			...
			$breadcrumb_html .= '<li><span class="breadcrumb-current">' . apply_filters( 'my_breadcrumb_title', get_the_title() ) . '</span></li>';
			...
			$breadcrumb_html .= '<li><span class="breadcrumb-current">' . apply_filters( 'my_breadcrumb_title', single_cat_title( '', false ) ) . '</span></li>';
			$breadcrumb_html .= $breadcrumb_after;
			echo wp_kses_post( $breadcrumb_html );

		} elseif ( is_search() ) { /* Search Archive */
			$breadcrumb_html .= $breadcrumb_beore . $breadcrumb_home_tag . $breadcrumb_bridge_tag;
			$breadcrumb_html .= '<li><span class="breadcrumb-current">' . apply_filters( 'my_breadcrumb_title', '「' . get_query_var( 's' ) . '」の検索結果' ) . '</span></li>';
			$breadcrumb_html .= $breadcrumb_after;
			echo wp_kses_post( $breadcrumb_html );

		} elseif ( is_tag() ) { /* Tag Archive */
			$breadcrumb_html .= $breadcrumb_beore . $breadcrumb_home_tag . $breadcrumb_bridge_tag;
			$breadcrumb_html .= '<li><span class="breadcrumb-current">' . apply_filters( 'my_breadcrumb_title', single_tag_title( '', false ) ) . '</span></li>';
			$breadcrumb_html .= $breadcrumb_after;
			echo wp_kses_post( $breadcrumb_html );

		} elseif ( is_post_type_archive() ) { /* Other PostType Archive */
			$breadcrumb_html .= $breadcrumb_beore . $breadcrumb_home_tag . $breadcrumb_bridge_tag;
			$breadcrumb_html .= '<li><span class="breadcrumb-current">' . apply_filters( 'my_breadcrumb_title', post_type_archive_title( '', false ) ) . '</span></li>';
			$breadcrumb_html .= $breadcrumb_after;
			echo wp_kses_post( $breadcrumb_html );
			...
			$breadcrumb_html .= '<li><span class="breadcrumb-current">' . apply_filters( 'my_breadcrumb_title', single_term_title( '', false ) ) . '</span></li>';
			$breadcrumb_html .= $breadcrumb_after;
			echo wp_kses_post( $breadcrumb_html );

		} elseif ( is_author() ) { /* Author Archive */
			$breadcrumb_html .= $breadcrumb_beore . $breadcrumb_home_tag . $breadcrumb_bridge_tag;
			$breadcrumb_html .= '<li><span class="breadcrumb-current">' . apply_filters( 'my_breadcrumb_title', get_the_author() ) . '</span></li>';
			$breadcrumb_html .= $breadcrumb_after;
			echo wp_kses_post( $breadcrumb_html );
			...
			$breadcrumb_html .= $breadcrumb_beore . $breadcrumb_home_tag . $breadcrumb_bridge_tag;
			$breadcrumb_html .= '<li><span class="breadcrumb-current">404</span></li>';
			$breadcrumb_html .= $breadcrumb_after;
			echo wp_kses_post( $breadcrumb_html );
