...
<div class="p-entry-pager">
	<div class="p-entry-pager__prev"><?php previous_post_link( '%link', '<i class="fas fa-angle-left"></i> 前の記事', false ); ?></div><!-- /.p-entry-pager__prev -->
	<div class="p-entry-pager__next"><?php next_post_link( '%link', '次の記事 <i class="fas fa-angle-right"></i>', false ); ?></div><!-- /.p-entry-pager__next -->
</div><!-- /p-entry-pager -->
